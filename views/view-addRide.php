...
<h2 class="text-center my-4">Ajouter Trajet</h2>
        ...
        <form action="" method="POST" novalidate>
            ...
            <select class="form-control <?= isset($errors['enterprise']) ? 'is-invalid' : '' ?> <?= isset($_POST['enterprise']) && !isset($errors['enterprise']) ? 'is-valid' : '' ?>" name="enterprise" id="enterprise">
                ...
                <?php foreach (Entreprise::getAllEnteprises() as $entreprise) { ?>
                    <option value="<?= $entreprise['id_entreprise'] ?>" <?= isset($_POST['enterprise']) && $_POST['enterprise'] == $entreprise['id_entreprise'] ? 'selected' : '' ?>><?= $entreprise['nom_entreprise'] ?></option>
                <?php } ?>
            </select>
            ...
            <div class="my-3">
                ...
                <span class="d-lg-inline d-none input-warning ms-2"><?= $errors['password'] ?? '' ?></span>
            ...
            <div class="my-3">
                ...
                <span class="d-lg-inline d-none input-warning ms-2"><?= $errors['confirmPassword'] ?? '' ?></span>
